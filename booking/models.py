...
class Booking(models.Model):
    ...
    def __str__(self):
        return f'{self.guest_name} - {self.seat.seat_number} on {self.booking_date} at {self.booking_time}'

    class Meta:
        constraints = [
            models.UniqueConstraint(fields=['seat', 'guest_name', 'booking_date', 'booking_time'], name='unique_booking')
        ]
